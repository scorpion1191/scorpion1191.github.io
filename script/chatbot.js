...
function df_text_query (queryText) {
    ...
    fetch('http://anonymus-chatbot.herokuapp.com/api/df_text_query', {
            method: 'POST',
...
function df_event_query(eventName) {
    ...
    const res = axios.post('http://anonymus-chatbot.herokuapp.com/api/df_event_query',  {event: eventName, userID: cookies.get('userID')});
